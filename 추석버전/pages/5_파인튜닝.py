...
st.write("제 파인튜닝 페이지는 '필로소피 AI' 유튜브 채널을 참조했습니다.")
...
st.markdown('[사용한 데이터 셋](https://huggingface.co/datasets/junghwa28/recipes)')
...
st.subheader("|결과")
st.markdown('[모델 바로가기](https://huggingface.co/junghwa28/finalrecipes)')
